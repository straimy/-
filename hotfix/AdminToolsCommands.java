    ...
    private static void registerCredits(RegisterCommandsEvent e,String root){
        e.getDispatcher().register(Commands.literal(root).requires(s->s.hasPermission(2))
            .then(Commands.literal("give")
                .then(Commands.argument("amount",IntegerArgumentType.integer(1,1_000_000)).executes(ctx->change(ctx.getSource(),ctx.getSource().getPlayerOrException(),IntegerArgumentType.getInteger(ctx,"amount"),false)))
                .then(Commands.argument("player",EntityArgument.player()).then(Commands.argument("amount",IntegerArgumentType.integer(1,1_000_000)).executes(ctx->change(ctx.getSource(),EntityArgument.getPlayer(ctx,"player"),IntegerArgumentType.getInteger(ctx,"amount"),false)))))
            .then(Commands.literal("set")
                .then(Commands.argument("amount",IntegerArgumentType.integer(0,1_000_000)).executes(ctx->change(ctx.getSource(),ctx.getSource().getPlayerOrException(),IntegerArgumentType.getInteger(ctx,"amount"),true)))
                .then(Commands.argument("player",EntityArgument.player()).then(Commands.argument("amount",IntegerArgumentType.integer(0,1_000_000)).executes(ctx->change(ctx.getSource(),EntityArgument.getPlayer(ctx,"player"),IntegerArgumentType.getInteger(ctx,"amount"),true)))))
