...
pub const GGO_VERSION: &str = "v29";
pub const CORE_ARCHIVE_PATH: &str = "client/mods/gungloryonline-core-0.8.7-v29.jar";
pub const UI_ARCHIVE_PATH: &str = "client/mods/gungloryonline-ui-0.8.7-v29.jar";
pub const CORE_FILE_NAME: &str = "gungloryonline-core-0.8.7-v29.jar";
pub const UI_FILE_NAME: &str = "gungloryonline-ui-0.8.7-v29.jar";
pub const RESOURCE_PACK_FILE_NAME: &str =
    "GunGloryOnline-ResourcePack-1.20.1-v5-swittie-social.zip";

pub const CORE_SHA256: &str =
    "f6a92457007fe8d9bc78126454cbc46497e9d3676333956a875a03be9aa16665";
pub const UI_SHA256: &str =
    "5edba86bba883125976df5e39f6a83e4dc2e62cd2b28a21f060bb43f48ac13dc";
pub const RESOURCE_PACK_SHA256: &str =
    "33c40c492ce5db2b8312dc09326a64bdec4f11006ace07ab09a41a213a9308b7";

pub const CORE_SIZE: u64 = 385_467;
pub const UI_SIZE: u64 = 85_448;
...
pub enum LocalInstallError {
    #[error("I/O error: {0}")]
    Io(#[from] io::Error),
    #[error("invalid GGO package zip: {0}")]
    Zip(#[from] zip::result::ZipError),
    #[error("missing expected file in GGO package: {0}")]
    Missing(String),
...
pub fn install_local(
    ...
    let resource_pack_target = install_dir
        .join("resourcepacks")
        .join(RESOURCE_PACK_FILE_NAME);
    install_source_file(
        resource_pack_zip,
        &resource_pack_target,
        RESOURCE_PACK_SIZE,
...
fn install_source_file(
    ...
    if !source_hash.eq_ignore_ascii_case(expected_sha256) {
        return Err(LocalInstallError::Checksum(
...
mod tests {
    ...
    fn resource_pack_name_is_normalized() {
        assert!(!RESOURCE_PACK_FILE_NAME.contains("(2)"));
